...
class NblastArena:
    ...
    def query_target(
        ...
        return self._impl.query_target(query_idx, target_idx, normalise, symmetric)
    ...
    def queries_targets(
        ...
        return self._impl.queries_targets(query_idxs, target_idxs, normalise, symmetric)

    def all_v_all(
        self, normalise=False, symmetric=False
    ) -> Dict[Tuple[Idx, Idx], float]:
        return self._impl.all_v_all(normalise, symmetric)
